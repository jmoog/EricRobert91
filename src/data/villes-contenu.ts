...
export interface VilleContenu {
  /** Complément du H1 : « Couvreur à X : {h1tag} » */
  h1tag: string;
...
export const villesContenu: Record<string, VilleContenu> = {
  linas: {
    ...
    meta: "Couvreur à Linas (91310) : Éric Robert, artisan RGE basé dans la commune. Toiture, ramonage, démoussage — intervention immédiate, devis gratuit.",
    hero: [
      "À Linas, vous n'appelez pas un couvreur de passage : vous appelez l'artisan du village. L'atelier d'Éric Robert se trouve route d'Orléans, à deux pas de l'autodrome — c'est d'ici que partent tous les chantiers du département.",
  ...
  arpajon: {
    ...
    meta: "Couvreur à Arpajon (91290) : réfection, réparation et entretien de toiture par Éric Robert, artisan RGE à 10 minutes. Devis et déplacement gratuits.",
    hero: [
  ...
  'corbeil-essonnes': {
    ...
    meta: "Couvreur à Corbeil-Essonnes (91100) : toiture, Velux, zinguerie par Éric Robert, artisan RGE Qualibat. Intervention dans tous les quartiers, devis gratuit.",
    hero: [
  ...
  montgeron: {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Montgeron (91230) : démoussage, ramonage et entretien de toiture en bordure de Sénart, par Éric Robert. Devis gratuit, artisan RGE Qualibat.",
    hero: [
  ...
  etrechy: {
    h1tag: 'votre expert couverture et charpente',
    meta: "Couvreur à Étréchy (91580) : réfection, charpente et entretien de toiture dans la vallée de la Juine par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  'savigny-sur-orge': {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Savigny-sur-Orge (91600) : rénovation, isolation et entretien des toits saviniens par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  'morsang-sur-orge': {
    ...
    meta: "Couvreur à Morsang-sur-Orge (91390) : réparation, démoussage et isolation par Éric Robert, artisan RGE à 15 minutes. Devis et déplacement gratuits.",
    hero: [
      ...
      "Éric Robert intervient chez les Morsaintois pour les réparations, le démoussage et l'isolation, à un quart d'heure de son atelier de Linas. Devis et déplacement gratuits.",
    ],
    corps: [
  ...
  mereville: {
    ...
    meta: "Couvreur à Méréville (91660) : couverture, charpente et entretien des toits du sud Essonne par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  'milly-la-foret': {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Milly-la-Forêt (91490) : démoussage, couverture et charpente aux portes du Gâtinais par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  palaiseau: {
    h1tag: 'votre expert toiture, devis gratuit',
    meta: "Couvreur à Palaiseau (91120) : toiture, isolation et Velux du centre au plateau, par Éric Robert, artisan RGE Qualibat. Devis et déplacement gratuits.",
    hero: [
  ...
  'sainte-genevieve-des-bois': {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Sainte-Geneviève-des-Bois (91700) : rénovation, démoussage, isolation par Éric Robert, artisan RGE à 10 minutes. Devis gratuit.",
    hero: [
      ...
      "À dix minutes de son atelier de Linas, Éric Robert est l'un des couvreurs les plus proches des Génovéfains. Réactivité et devis gratuit — la proximité a des avantages concrets.",
    ],
    corps: [
  ...
  igny: {
    ...
    meta: "Couvreur à Igny (91430) : isolation, réparation et entretien de toiture dans la vallée de la Bièvre par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  orsay: {
    h1tag: 'votre expert toiture',
    meta: "Couvreur à Orsay (91400) : toiture, isolation et fenêtres de toit dans la vallée de l'Yvette par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  'gif-sur-yvette': {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Gif-sur-Yvette (91190) : démoussage, toiture et isolation, de la vallée à Chevry, par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  draveil: {
    h1tag: 'devis gratuit, intervention rapide',
    meta: "Couvreur à Draveil (91210) : ramonage, démoussage et toiture entre Seine et Sénart par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  evry: {
    h1tag: 'votre expert toiture, devis gratuit',
    meta: "Couvreur à Évry-Courcouronnes (91000) : Velux, toiture et zinguerie dans la préfecture du 91 par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  saclas: {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à Saclas (91690) : couverture, charpente et entretien des maisons de pays par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  wissous: {
    h1tag: 'devis gratuit, artisan RGE',
    meta: "Couvreur à Wissous (91320) : réparation, isolation et entretien de toiture aux portes d'Orly par Éric Robert, artisan RGE. Devis gratuit.",
    hero: [
  ...
  pecqueuse: {
    h1tag: 'votre expert toiture',
    meta: "Couvreur à Pecqueuse (91470) : couverture, démoussage et charpente dans le pays de Limours par Éric Robert, artisan RGE Qualibat. Devis gratuit.",
    hero: [
  ...
  champlan: {
    h1tag: 'devis gratuit, artisan local',
    meta: "Couvreur à Champlan (91160) : réparation, entretien et isolation de toiture par Éric Robert, artisan RGE à quelques minutes. Devis gratuit.",
    hero: [
  ...
  'la-ville-du-bois': {
    h1tag: 'votre professionnel de la toiture',
    meta: "Couvreur à La Ville-du-Bois (91620) : entretien, démoussage et réparation de toiture par Éric Robert, artisan RGE voisin. Devis gratuit.",
    hero: [
      "Voisine directe de Linas le long de la N20, La Ville-du-Bois aligne ses quartiers pavillonnaires sous les arbres — la commune porte bien son nom. Pour ses habitants, l'atelier d'Éric Robert est à cinq minutes : difficile de faire plus proche.",
